...
Json::Json OpenAI::OpenAIApi::Get(const std::string& methodName) const
{
...
Json::Json OpenAI::OpenAIApi::Post(const std::string& methodName, const Json::Json& params) const
{
...
OpenAI::ChatCompletionsResponse::Ptr OpenAI::OpenAIApi::ChatCompletions(const ChatCompletionsRequest::Ptr& completionsRequest) const
{
    const Json::Json requestBody = completionsRequest;
    const Json::Json responseBody = Post("chat/completions", requestBody);
...
OpenAI::FileInfo::Ptr OpenAI::OpenAIApi::DeleteFile(const std::string& fileId) const
{
    const auto httpContext = std::make_shared<HttpContext<EmptyBody, StringBody>>();
    httpContext->Request->version(HTTP_VERSION);
...
std::string OpenAI::OpenAIApi::CreateTranscription(const TranscriptionsRequest::Ptr& transcriptionsRequest) const
{
...
OpenAI::CreateImageResponse::Ptr OpenAI::OpenAIApi::CreateImage(const CreateImageRequest::Ptr& createImageRequest) const
{
    const Json::Json requestBody = createImageRequest;
    const Json::Json responseBody = Post("images/generations", requestBody);
...
std::string OpenAI::OpenAIApi::Speech(const SpeechRequest::Ptr& speechRequest) const
{
